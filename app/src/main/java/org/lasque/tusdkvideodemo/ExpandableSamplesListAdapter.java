...
import org.lasque.tusdkvideodemo.custom.MultipleCameraRatioActivity;
import org.lasque.tusdkvideodemo.suite.MoviePreviewAndCutActivity;
import org.lasque.tusdkvideodemo.suite.MovieRecordAndPreviewEditorActivity;
...
public class ExpandableSamplesListAdapter extends BaseExpandableListAdapter
{
    ...
    {
    	// 功能组合展示
    	RECORD_PREVIEW_EDITOR(R.string.lsq_record_preview_editor, MovieRecordAndPreviewEditorActivity.class.getName(), false, true),
    	...
    	FULL_SCREEN_RECORD_PREVIEW_RATIO_EDITOR(R.string.lsq_full_screen_record_preview_ratio_editor,MultipleCameraRatioActivity.class.getName(), false, true),
