...
//    }
    ...
    protected void bindModel()
    {
        ...
        findViewById(com.upyun.shortvideo.R.id.lsq_scence_effect_cell_layout).setVisibility( isUndoCell ? View.GONE : View.VISIBLE);
    ...
    public TuSdkTextButton getUndoButton()
    {
        if ( mUndoButton == null)
        {
            mUndoButton = (TuSdkTextButton) findViewById(com.upyun.shortvideo.R.id.lsq_scence_effect_cell_undo_btn);
        }
        return mUndoButton;
    }
